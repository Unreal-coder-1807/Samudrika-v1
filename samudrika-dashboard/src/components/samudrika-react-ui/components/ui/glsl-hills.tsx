          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                float opacity = (128.0 - dist) / 256.0 * 0.8;
                // Deep maritime teal/cyan color
                vec3 color = vec3(0.1, 0.45, 0.5);
                
                // Add a subtle glow based on position
                color += vec3(0.0, 0.1, 0.1) * (1.0 - dist/128.0);
