  ...
  return (
    <div style={cardStyle}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div>
          <label style={{ fontSize: 13, fontWeight: 500, color: "#E8F4FD", display: "block", marginBottom: 6 }}>
            Email
          </label>
          <input
            type="email"
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "rgba(255,255,255,0.45)", margin: 0 }}>
          ...
          <a href="/login" style={{ color: "#FFFFFF", fontWeight: 600, textDecoration: "underline", textUnderlineOffset: 3 }}>
            Sign in
          </a>
        </p>
      </form>
